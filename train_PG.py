...
from PG_v2_his import PolicyGradient
    ...
    for episode in range(num_episodes):
        ...
        while True:
            ...
            for iot_index in range(env.n_iot):
                ...
                # print(f'\nIOT INDEX: {iot_index} - UPDATE LSTM LENGTH: {len(lstm_state_all_[iot_index, :])}\n')
        ...
        file_name = 'output_w1=0.5,w2=0.5.txt'
...
def main(args):
    ...
    for iot in range(args.num_iot):
        iot_RL_list.append(PolicyGradient(env.n_actions, env.n_features, env.n_time,
                                        env.n_lstm_state,
